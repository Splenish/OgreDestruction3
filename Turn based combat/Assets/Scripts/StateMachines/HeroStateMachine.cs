...
public class HeroStateMachine : MonoBehaviour {
    ...
    void Update()
    {
		...
		if (bsMachine.GetComponent<BattleStateMachine>().victoryBool)
        {
            //Debug.Log("attackBool.victoryBool =" + attackBool.victoryBool);
			Debug.Log("victorybool == true");
            ...
            switch (currentState)
            {
                ...
                case (TurnState.Dead):
                    ...
                    else
                    {
                        ...
                        alive = false;
                        PlayerPrefs.SetFloat(heroHPString, 1.0f);
  ...
  //      attackBool.magicAttack = false;
    ...
    void DoDamage()
    {
        float calc_damage = Mathf.Floor((hero.curATK + BSM.PerformList[0].choosenAttack.attackDamage) * Random.Range(0.8f, 1f));
